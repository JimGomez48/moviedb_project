    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aid', models.ForeignKey(db_column=b'aid', to='MovieDB.Actor')),
                ('mid', models.ForeignKey(db_column=b'mid', to='MovieDB.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='MovieDirector',
            fields=[
                ('id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('did', models.ForeignKey(db_column=b'did', to='MovieDB.Director')),
                ('mid', models.ForeignKey(db_column=b'mid', to='MovieDB.Movie')),
            ],
        ),
        migrations.CreateModel(
