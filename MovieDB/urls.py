...
router.register(prefix=r'movies', viewset=api_views.MoviesViewSet)
router.register(prefix=r'actors', viewset=api_views.ActorsViewSet)
router.register(prefix=r'directors', viewset=api_views.DirectorsViewSet)
router.register(prefix=r'companies', viewset=api_views.CompaniesViewSet)
router.register(prefix=r'reviews', viewset=api_views.ReviewsViewSet)
