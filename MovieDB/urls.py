...
urlpatterns = [
    ...
    url(r'^BrowseActor/page=(?P<page_request>\d+)/$', views.BrowseActorView.as_view(), name='BrowseActor'),
    url(r'^BrowseActor/search_term=(?P<search_term>[\w+\s+]+)/page=(?P<page_request>\d+)/$', views.BrowseActorView.as_view(), name='BrowseActor'),
    # Browse Director
    ...
    url(r'^BrowseDirector/page=(?P<page_request>\d+)/$', views.BrowseDirectorView.as_view(), name='BrowseDirector'),
    url(r'^BrowseDirector/search_term=(?P<search_term>[\w+\s+]+)/page=(?P<page_request>\d+)/$', views.BrowseDirectorView.as_view(), name='BrowseDirector'),
    # Detail
